...
const textareaStyles = tv({
  extend: focusStyles,
  base: "field-sizing-content max-h-96 min-h-16 w-full min-w-0 rounded border-2 border-muted px-2.5 py-2 text-base shadow-xs transition duration-200 data-disabled:opacity-50 sm:text-sm",
})
