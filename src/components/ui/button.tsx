...
const buttonStyles = tv({
  ...
  variants: {
    intent: {
      ...
      brand:
      "[--btn-bg:var(--brand)] [--btn-fg:var(--brand-fg)] [--btn-icon:var(--brand)] [--btn-outline:var(--brand)] [--btn-overlay:var(--brand)]/85",
      brandLight:
      "[--btn-bg:var(--brand-fg)] [--btn-fg:var(--brand)] [--btn-icon:var(--brand-fg)] [--btn-outline:var(--brand-fg)] [--btn-overlay:var(--brand-fg)]/85 inset-ring-0",
    },
    size: {
      xs: [
