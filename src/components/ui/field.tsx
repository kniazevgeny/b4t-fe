  ...
  return (
    <InputPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        "relative block w-full bg-light-gray rounded-lg px-3 py-3 placeholder-muted-fg outline-hidden sm:px-3 sm:py-1.5 sm:text-sm/6 [&::-ms-reveal]:hidden [&::-webkit-search-cancel-button]:hidden",
      )}
    />
  )
}
